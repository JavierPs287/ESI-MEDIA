...
class PasswordResetControllerTest {
    ...
    void testForgotPassword_emailValido() throws Exception {
        doNothing().when(userService).startPasswordReset(anyString());
    ...
    void testResetPassword_failure() throws Exception {
        doThrow(new RuntimeException("Token inválido")).when(userService).resetPassword(anyString(), anyString());
    ...
    void testResetPassword_passwordVacia() throws Exception {
        doThrow(new RuntimeException("Contraseña vacía")).when(userService).resetPassword(anyString(), anyString());
    ...
    void testResetPassword_passwordDebil() throws Exception {
        doThrow(new RuntimeException("Contraseña muy débil")).when(userService).resetPassword(anyString(), anyString());
